...
import wrapper.datastructures.DataStructure.VisualListener;
...
public class RenderManager extends BorderPane implements VisualListener {
	...
	public Render resolveRender(DataStructure struct) {
		...
		case box:
			...
			break;
		case tree:
			render = new KTreeRender_FX(struct, struct.visualOption, 40, 40, 5, 5);
			break;
		case single:
			render = new SingleElementRender_FX(struct, 80, 40);
			break;
		}
