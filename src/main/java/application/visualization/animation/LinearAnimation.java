...
public class LinearAnimation extends Animation {
     ...
     * 
     * @param owner The owner of the moving element.
     * @param e The moving element.
    ...
    /**
     * Creates a LinearAnimation between the moving element e's current position and an end point.
     * 
     * @param owner The owner of the moving element.
     * @param e The moving element.
     * @param end_x End x.
