...
public abstract class Animation {
	...
	/**
	 * Forces the animation to finish. Called automatically after the last
	 * frame.
	 */
	public void finish() {
		timeline.stop();
	...
	/**
	 * Generate points on a straight line between a a starting point and an end
	 * point.
	 * 
	 * @param x1
	 *            Starting x.
	 ...
	 * @param restframes
	 *            The proportion frames at rest at the end of the animation the
	 *            {@code points}.
	 * @return An array with the x-coordinate for step i at ans[0][i] and the
	 *         y-coordinte at ans[1][i].
	 */
	public double[][] linearAnimationPath(double x1, double y1, double x2, double y2, int frame_count,
			double restframes) {
