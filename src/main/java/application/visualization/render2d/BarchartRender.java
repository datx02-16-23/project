...
public class BarchartRender extends Render {
	...
	private void drawAxes() {
		...
		// context.strokeLine(padding - hspace / 4, i * node_height / 5, padding
		// + hspace / 2, i * node_height / 5);
		// }
	}

	public enum GrowthDirection {
		UP("Up", "Positive values will expand above the x-axis.", 0), DOWN("Down",
				"Positive values will expand below the x-axis.", 1);
