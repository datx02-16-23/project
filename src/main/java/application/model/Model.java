...
public class Model {
    ...
    /**
     * Step the model backwards. This method will reset the model and call stepForward() index - 1 times.
     * 
     ...
     * 
     * @param toStepNo The step to jump to.
     */
     ...
     * 
     * @param structs The DataStructure map to use.
     * @param ops The Operation list to use.
     */
    ...
    /**
     * Returns the DataStructure map held by this Model. <b>SHOULD NOT BE USED TO ADD OR REMOVE STRUCTURES FROM THE
     * MODEL!</b>
     * 
    ...
    /**
     * Returns the Operation list held by this Model. <b>SHOULD NOT BE USED TO ADD OR REMOVE OPERATIONS FROM THE
     * MODEL!</b>
     * 
    ...
    /**
     * Set the Operation list used by this Model, and reset the index. The previous list will be lost.
     * 
     * @param newOperations The new list of operations to use.
     */
    ...
    /**
     * Returns true if this model has been hard cleared, or if it has not been changed since the the constructor was
     * called.
     * 
