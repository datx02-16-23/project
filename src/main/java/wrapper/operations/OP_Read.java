...
public class OP_Read extends OP_ReadWrite {
    ...
    /**
     * Set the source variable for this Read operation. The identifier of the variable should be previously declared in
     * the header.
     * 
    ...
    /**
     * Set the value(s) which were read from {@code source}. This should be the value of {@code target} and the
