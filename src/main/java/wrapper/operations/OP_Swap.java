...
public class OP_Swap extends Operation implements Consolidable {
    ...
    /**
     * Set var1 for this Swap operation. The identifier of the variable should be previously declared in the header.
     * 
    ...
    /**
     * Set var2 for this Swap operation. The identifier of the variable should be previously declared in the header.
     * 
    ...
    public Operation consolidate (List<OP_ReadWrite> rwList){
        ...
        if (rw0.getSource() == null || rw0.getTarget() == null || rw1.getSource() == null || rw1.getTarget() == null || rw2.getSource() == null || rw2.getTarget() == null) {
