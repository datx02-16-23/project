...
public class Header implements Serializable {
    ...
    /**
     * The version number for this file. Version 0 is reserved for when the
    ...
    /**
     * Create a {@code Header} object with an unknown version number and no
     * declared variables. You may populate the HashMap
