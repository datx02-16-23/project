...
public class Interpreter {
    ...
    /**
     * Reduce the size of the working set by removing the last element and adding it first to the list of low level
     * operations.
     */
    ...
    /**
     * Try to expend the current working set. Messages are immediately added to high level operations, as are
     * initialization.
     * 
    ...
    public class Consolidator {
        ...
        /**
         * Returns true if the type of the OperationType given as argument is among the test cases used by this
         * Consolidator.
         * 
        ...
        /**
         * Adds another Consolidable for this Consolidator. Will not any any Consolidable type more than once.
         * 
        ...
        /**
         * Attempt to consolidate the working set supplied. Returns a consolidated operation if successful, null
         * otherwise.
         * 
