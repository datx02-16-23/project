...
public interface Consolidable {
    ...
    /**
     * Attempt to consolidate a list of read/write operations. The method should behave as it were static, that is the
     * state of the calling initialization should not matter.
     * 
    ...
    /**
     * Returns the number of primitive (read/write) operations this high level operation consists of. The method should
     * behave as it were static, that is the state of the calling initialization should not matter.
     * 
