...
public abstract class ARenderAnimation {
    ...
    public static ParallelTransition linear(Element e, double x1, double y1, double x2, double y2, long millis,
	    ARender render, AnimationOption... options) {
	// @formatter:on
	...
	private static void setOnFinished(ARender render, AVElement orig, final AVElement clone,
		ParallelTransition pt, final boolean ghost) {
